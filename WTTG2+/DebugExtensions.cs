...
public static class DebugExtensions
{
	...
	public static void DebugCapsule(Vector3 start, float height, Color color, float radius = 1f, int direction = 0, float duration = 0f, bool depthTest = true)
	{
		...
		DebugCircle(start, vector3, color, radius, duration, depthTest);
		DebugCircle(vector2, -vector3, color, radius, duration, depthTest);
	...
	public static void DrawCapsule(Vector3 start, float height, Color color, float radius = 1f, int direction = 0)
	{
		...
		start = vector6 + (start - vector6).normalized * num;
		vector2 = vector6 + (vector2 - vector6).normalized * num;
		DrawCircle(start, vector3, color, radius);
		DrawCircle(vector2, -vector3, color, radius);
