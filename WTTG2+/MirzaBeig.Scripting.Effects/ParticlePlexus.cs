			...
			else
			{
				...
				for (int m = 0; m < particleCount; m++)
				{
					...
					for (int n = m + 1; n < particleCount; n++)
					{
						...
						vector4.x = particlePositions[m].x - particlePositions[n].x;
						vector4.y = particlePositions[m].y - particlePositions[n].y;
						vector4.z = particlePositions[m].z - particlePositions[n].z;
						float num7 = vector4.x * vector4.x + vector4.y * vector4.y + vector4.z * vector4.z;
						if (num7 <= num3)
						{
							LineRenderer item2;
							if (num2 == num)
