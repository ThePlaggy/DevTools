...
public static class Noise2
{
	...
	public static float simplex(float x, float y, float z)
	{
		...
		{
			num36 *= num36;
			int num38 = perm[num30 + num15 + perm[num31 + num16 + perm[num32 + num17]]];
			num37 = num36 * num36 * (num38 & 0xF) switch
			{
				0 => num21 + num22, 
				1 => 0f - num21 + num22, 
				2 => num21 - num22, 
		...
		{
			num39 *= num39;
			int num41 = perm[num30 + num18 + perm[num31 + num19 + perm[num32 + num20]]];
			num40 = num39 * num39 * (num41 & 0xF) switch
			{
				0 => num24 + num25, 
				1 => 0f - num24 + num25, 
				2 => num24 - num25, 
		...
		float num42 = 0.6f - num27 * num27 - num28 * num28 - num29 * num29;
		float num43;
		if (num42 < 0f)
		{
			num43 = 0f;
		...
		{
			num42 *= num42;
			int num44 = perm[num30 + 1 + perm[num31 + 1 + perm[num32 + 1]]];
			num43 = num42 * num42 * (num44 & 0xF) switch
			{
				0 => num27 + num28, 
				1 => 0f - num27 + num28, 
				2 => num27 - num28, 
		...
		return 32f * (num34 + num37 + num40 + num43);
	}
	...
	public static float perlinUnoptimized(float x, float y, float z)
	{
		...
		num10 = grad(perm[num + perm[num8 + perm[num3]]], num4, y2, num6);
		to = grad(perm[num + perm[num8 + perm[num9]]], num4, y2, z2);
		float to2 = lerp(num10, to, t);
		float num12 = lerp(num11, to2, t2);
		num10 = grad(perm[num7 + perm[num2 + perm[num3]]], x2, num5, num6);
		to = grad(perm[num7 + perm[num2 + perm[num9]]], x2, num5, z2);
		num11 = lerp(num10, to, t);
		num10 = grad(perm[num7 + perm[num8 + perm[num3]]], x2, y2, num6);
		to = grad(perm[num7 + perm[num8 + perm[num9]]], x2, y2, z2);
		to2 = lerp(num10, to, t);
		float to3 = lerp(num11, to2, t2);
		return 0.936f * lerp(num12, to3, t3);
	}
