...
namespace MirzaBeig.Scripting.Effects
{
    ...
    public static class Noise
    {
        ...
        public static float perlinUnoptimized(float x, float y, float z)
        {
            ...
            num2 &= 255;
            num3 &= 255;
            float num13 = Noise.fade(num6);
            float num14 = Noise.fade(num5);
            float num15 = Noise.fade(num4);
            float num16 = Noise.grad((int)Noise.perm[num + (int)Noise.perm[num2 + (int)Noise.perm[num3]]], num4, num5, num6);
            float num17 = Noise.grad((int)Noise.perm[num + (int)Noise.perm[num2 + (int)Noise.perm[num12]]], num4, num5, num9);
            float num18 = Noise.lerp(num16, num17, num13);
            num16 = Noise.grad((int)Noise.perm[num + (int)Noise.perm[num11 + (int)Noise.perm[num3]]], num4, num8, num6);
            num17 = Noise.grad((int)Noise.perm[num + (int)Noise.perm[num11 + (int)Noise.perm[num12]]], num4, num8, num9);
            float num19 = Noise.lerp(num16, num17, num13);
            float num20 = Noise.lerp(num18, num19, num14);
            num16 = Noise.grad((int)Noise.perm[num10 + (int)Noise.perm[num2 + (int)Noise.perm[num3]]], num7, num5, num6);
            num17 = Noise.grad((int)Noise.perm[num10 + (int)Noise.perm[num2 + (int)Noise.perm[num12]]], num7, num5, num9);
            num18 = Noise.lerp(num16, num17, num13);
            num16 = Noise.grad((int)Noise.perm[num10 + (int)Noise.perm[num11 + (int)Noise.perm[num3]]], num7, num8, num6);
            num17 = Noise.grad((int)Noise.perm[num10 + (int)Noise.perm[num11 + (int)Noise.perm[num12]]], num7, num8, num9);
            num19 = Noise.lerp(num16, num17, num13);
            float num21 = Noise.lerp(num18, num19, num14);
            return 0.936f * Noise.lerp(num20, num21, num15);
        }
        ...
        public static float simplexUnoptimized(float x, float y, float z)
        {
            ...
            float num3 = y + num;
            float num4 = z + num;
            int num5 = Noise.floor(num2);
            int num6 = Noise.floor(num3);
            int num7 = Noise.floor(num4);
            float num8 = (float)(num5 + num6 + num7) * Noise.G3;
            float num9 = (float)num5 - num8;
            float num10 = (float)num6 - num8;
            float num11 = (float)num7 - num8;
